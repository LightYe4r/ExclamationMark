    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('caller_location', models.CharField(max_length=50)),
                ('category', models.CharField(choices=[('1번', '1번'), ('2번', '2번'), ('3번', '3번'), ('4번', '4번'), ('5번', '5번'), ('6번', '6번'), ('7번', '7번'), ('8번', '8번'), ('9번', '9번'), ('10번', '10번')], max_length=3)),
